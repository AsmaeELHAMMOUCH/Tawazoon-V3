                ...
                <div className="bg-gradient-to-br from-blue-50/60 via-blue-50/40 to-slate-50/60 border border-blue-100/80 rounded-2xl p-4 mt-2 shadow-lg backdrop-blur-sm">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
                        ...
                        <KPICardGlass
                            ...
                            tone="blue"
                            emphasize
                            total={formatSmallNumber((totaux?.total_mod_calcule || totaux?.fte_calcule || 0) + (totaux?.total_moi_target || totaux?.total_moi || 0), 2)}
                            toggleable={false}
                            customFooter={
                                <div className="flex justify-evenly items-center w-full px-2 mt-1">
                                    ...
                                    <div className="flex flex-col items-center">
                                        ...
                                        <span className="text-[10px] font-bold text-slate-700">{formatSmallNumber(totaux?.total_mod_calcule || totaux?.fte_calcule, 2)}</span>
                                    </div>
                                    <div className="flex flex-col items-center">
                        ...
                        <KPICardGlass
                            ...
                            tone="amber"
                            emphasize
                            total={formatSmallNumber((totaux?.total_mod_target || totaux?.fte_arrondi || 0) + (totaux?.total_moi_target || 0) + ((!poste || poste === "__ALL__") ? (totaux?.total_aps_target || 0) : 0), 0)}
                            toggleable={false}
                            customFooter={
                                <div className="flex justify-between items-center w-full px-2 mt-1">
                                    <div className="flex flex-col items-center">
                                        ...
                                        <span className="text-[10px] font-bold text-slate-800">{formatSmallNumber(totaux?.total_mod_target || totaux?.fte_arrondi, 0)}</span>
                                    </div>
                                    <div className="flex flex-col items-center">
                        ...
                        {(() => {
                            ...
                            const targetMOD = totaux?.total_mod_target || totaux?.fte_arrondi || 0;
                            const targetMOI = totaux?.total_moi_target || totaux?.total_moi || 0;
                            const targetAPS = totaux?.total_aps_target || totaux?.total_aps || 0;
