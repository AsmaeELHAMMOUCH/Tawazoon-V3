  ...
  const openDetail = async (centre) => {
    ...
    try {
      if (typeof api.postesByCentre === "function") {
        ...
        // Better approach: Call simulate_vue_centre_optimisee with 0 volumes or use the result from consolidation if available?
        // For now, let's stick to base data, but it won't show the "Calculated" column for each post correctly unless we re-simulate.
        // TODO: Future improvement -> Call simulation endpoint for single centre to get breakdown.
